...
const ChatMessages = ({chatId, sesssion, initialMessages}: Props) => {
  ...
  return (
    <div className='p-5'>
        ...
        {messages?.map((message) => {
            ...
            const isSender = message.user.id === sesssion?.user.id;
            return (
                <div key={sesssion?.user.id} className='flex my-2 items-end'>
                    <UserAvatar
